...
from utils.infer import load_grami_enc
...
def main(cfg, debug):
    ...
    train_dl, val_dl, model, optimizer, scheduler, scaler, start_epoch, \
        ...
        setup_training(
            cfg,
            create_model_fn=lambda model_config, data_shapes, extra_config: VecParamsClassifier(model_config["classifier"], data_shapes, extra_config=extra_config),
